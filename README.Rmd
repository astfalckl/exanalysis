...
First thing is to generate the incidence matrices. (This takes a while to run so it currently executes by reading the file <tt> H_list </tt> in from the package)
